...
try
{
	...
	PreparedStatement pstmt=con.prepareStatement("select *from AddEmployeeDetails where eId=?");
	
	pstmt.setString(1,s1);
	
	ResultSet rs=pstmt.executeQuery("Select *from AddEmployeeDetails");
	...
	out.println("<h5><a href='AdminViewEmployeeDetails.html'>Click here to View employee details....!</a></h5>");
