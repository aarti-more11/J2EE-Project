...
try
{
	...
	PreparedStatement pstmt=con.prepareStatement("Delete from AddEmployeeDetails where eId=?");
	pstmt.setString(1, s1);
	
	int i=pstmt.executeUpdate();
	
	if(i>0){
		out.println("<h5>Employee removed from EMS successfully......!</h5>");
		out.println("<h5><a href='AdminViewEmployeeDetails.jsp'>Click here To View Employee Details</a></h5>");
	}
	else{
		out.println("<h5>Deletion Failed......!</h5>");
	}	
}
catch(Exception e)
{
