...
try
{
	...
	PreparedStatement pstmt=con.prepareStatement("select *from SignIn where empId=?");
	
	pstmt.setString(1,s1);
	
	ResultSet rs=pstmt.executeQuery("Select *from SignIn");
	...
	out.println("</table>");
	out.println("<h5><a href='EmployeeUpdateDetails.html'>Click here to Update....!</a></h5>");
