  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="EmployeeViewDetails.html">View</a>
        </li>
        
        <li class="nav-item">
          <a class="nav-link" href="EmployeeUpdateDetails.html">Update</a>
        </li>
        
        <li class="nav-item">
          <a class="nav-link" href="EmployeeViewSalaryDetails.html">ViewSalary</a>
        </li>
...
try
{
	...
	PreparedStatement pstmt=con.prepareStatement("Update SignIn set password=?, EmailId=?,FName=?,LName=?,FullName=?,ContactNo=? where empId=?");
	...
	pstmt.executeUpdate();
	out.println("<h5>Updation done successfully.....!</h5>");
	
	Statement stmt=con.createStatement();
	ResultSet rs=stmt.executeQuery("Select *from SignIn");
	
	out.println("<table border=1>");
	out.println("<tr>  <th>Employee Id</th> <th>Password</th>  <th>Email Id</th>  <th>First Name</th> <th>Last Name</th> <th>Full Name</th> <th>Contact Number</th> </tr>");
	out.println("<br>");
...
<% 
	...
	out.println("</table>");
	out.println("<h5><a href='AdminViewSalaryDetails.jsp'>Click here to View Salary Details....!</a></h5>");
	rs.close();
	con.close();
}
catch(Exception e)
