...
try
{
	...
	out.println("<h5>Registration done successfully.......!</h5>");
...
<section class="main">
	...
	out.println("</table>");
	out.println("<h5><a href='EMSLogin.html'>Click here to Login....!</a></h5>");
	//out.println("<h6><a href='EmployeeUpdateDetails.html'>Click here to update employee details....!</a></h6>");
	rs.close();
	con.close();	
  ...
  <div class="container overflow-hidden text-center">
    <div class="row gy-5">
      ...
      <div class="col-3">
        ...
        <h6 class="text-black">Shiv Bldg,Pune,<br>Maharashtra 411004</h6>
      </div>
