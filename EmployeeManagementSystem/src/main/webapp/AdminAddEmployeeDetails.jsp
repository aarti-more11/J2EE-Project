...
try
{
	...
	PreparedStatement pstmt=con.prepareStatement("Insert into AddEmployeeDetails values(?,?,?,?,?,?,?,?,?)");
	...
	pstmt.setInt(9,Integer.parseInt(s9));
	

	pstmt.executeUpdate();
	
	out.println("<h5>Employee Details Added successfully.......!</h5>");
	...
	out.println("<h5><a href='AdminRemoveEmployeeDetails.html'>Click here to Add Remove details....!</a></h5>");
