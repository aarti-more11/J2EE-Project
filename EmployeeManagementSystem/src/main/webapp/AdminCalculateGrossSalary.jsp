...
try
{
	...
	CallableStatement cs = con.prepareCall("{call GrossSalary(?,?,?,?,?)}"); 
	   cs.setString(1, s1);
	   cs.setInt(2,Integer.parseInt(s2)); 
	   cs.setInt(3,Integer.parseInt(s3));
	   cs.setInt(4,Integer.parseInt(s4));
	   
	   cs.registerOutParameter(5, Types.INTEGER); 
	   cs.execute(); 
	   
	out.println("<h5>Gross Salary Calculated.......!</h5>");
	out.println("<h4>Gross Salary of "+s1+" is <h4>"+cs.getInt(5));
	
	out.println("</table>");
	out.println("<h5><a href='AdminAddSalaryDetails.html'>Click here to Add Salary Details....!</a></h5>");
	con.close();	
