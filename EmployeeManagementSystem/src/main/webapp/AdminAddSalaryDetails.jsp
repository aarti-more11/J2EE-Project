...
try
{
	...
	PreparedStatement pstmt=con.prepareStatement("Insert into salary values(?,?,?,?,?)");
	
	pstmt.setInt(1,Integer.parseInt(s1));
	pstmt.setString(2,s2);
	pstmt.setInt(3,Integer.parseInt(s3));
	pstmt.setInt(4,Integer.parseInt(s4));
	pstmt.setInt(5,Integer.parseInt(s5));

	pstmt.executeUpdate();
	
	out.println("<h5>Salary Details Added successfully.......!</h5>");
	
	Statement stmt=con.createStatement();
	ResultSet rs=stmt.executeQuery("Select *from salary");
	out.println("<table border=1");
	out.println("<tr> <th>GrossSalary</th> <th>empId</th> <th>basicSalary</th> <th>PF</th> <th>DA</th>  </tr>");
	out.println("<br>");
	...
	out.println("</table>");
	out.println("<h5><a href='AdminLogin.html'>Click here to go on Home Page....!</a></h5>");
